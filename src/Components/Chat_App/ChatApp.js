...
// import ChatInputForm from './Chat-inputs'
...
// //firebase
// import firebase, { auth, fbAuthProvider, db, storage } from '../../config/firebase'
...
//   const usersTypingRef = db.ref('/usersCurrentlyTyping');
...
//    */
//   const appVersionRef = db.ref('/version');
//   let appVersion = null;
//   let isFirstRun = true;
